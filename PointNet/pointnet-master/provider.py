...
class PointCloudProvider(Sequence):
    ...
    def initialize_dataset():
        ...
        train_index = ['data/modelnet40_ply_hdf5_2048/ply_data_train_50-50.h5']
        test_index = ['data/modelnet40_ply_hdf5_2048/ply_data_test_50-50.h5']
        ...
        create_vds(train_index, 'train')
        create_vds(test_index, 'test')
